...
#   timestamp: 2024-03-26T08:59:02+00:00
...
class CycleEventSchema(BaseModel):
    ...
    is_notify_all: Optional[bool] = Field(
        False, description='是否通知所有订阅者', title='Is Notify All'
    )
...
class EventDrivenSchema(BaseModel):
    ...
    is_notify_all: Optional[bool] = Field(
        False, description='是否通知所有同名实例', title='Is Notify All'
    )
