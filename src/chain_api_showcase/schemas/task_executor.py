...
#   timestamp: 2024-03-06T08:20:24+00:00
...
class SubscribeEventNameEnum(BaseModel):
    __root__: Any = Field('ScStatus', const=True, title='SubscribeEventNameEnum')


class SubscribeEventSchema(BaseModel):
    event_name: SubscribeEventNameEnum = Field(
        ..., description='事件唯一标识，比如 ScStatus '
    )
