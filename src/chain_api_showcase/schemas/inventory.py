...
#   timestamp: 2024-03-18T08:09:30+00:00
...
class ELMessageNameEnum(Enum):
    containerAdd = 'containerAdd'
    other = 'other'


class ELTaskStatusEnum(Enum):
    start = 'start'
    cancel = 'cancel'
    finish = 'finish'
...
class EventListenSchema(BaseModel):
    area: Optional[str] = Field('', title='Area')
    block: Optional[str] = Field('', title='Block')
    messageName: ELMessageNameEnum
    task_status: ELTaskStatusEnum
...
class AddPointSchema(BaseModel):
    version: Optional[str] = Field('20240318_031730', title='Version')
